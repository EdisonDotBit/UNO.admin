...
<html>
    ...
    <body>
        ...
        <div class="main_nav">
            <button class="main_nav_btn top_btn_a active"><a href="">DATABASE</a></button>
        ...
        <div class="main_ui">
            <div class="create">
                ...
                <p class="create_title">Create Database: </p>
                    <input name="dbname" class="create_input" id="c_input" placeholder="Database name" required>
                    <button name="c_db" class="create_btn">CREATE</button>
                </form>

            </div>
            <div class="main_title"> Database List: </div>
            <ul class="tree">
                <li>_</li>
                <?php
                ...
                if($result_db > 0){
                    while($d_row = mysqli_fetch_assoc($fetch_db)){
                        ...
                        echo '
                <li>
                    <div onclick="expand(this)" id="'.$current.'" class="list_content">
                        <h1>- '.$current.'</h1>
                    ...
                    ';
                        ...
                        while ($list    = mysqli_fetch_assoc($fetch_tbl)){
                            $t_row = $list['Tables_in_'.strtolower($current)];
                            echo '
                        <li>
                            <div onclick="window.top.location.href='."'main.php?show=".$t_row."&current_db=".$current.'\'"id="'.$t_row.'" class="list_content table">
                                <h1> - '.$t_row.'</h1>
                            ...
                            echo '
                        <li>
                            <div onclick="window.top.location.href='."'tblist.php?method=create&current_db=".$current.'\'" class="list_content table">
                                <h1>+ Add Table</h1>
                ...
                ?>
                <li>
                    <div onclick="window.top.location.href = '#c_input'" class="list_content">
                        <h1>+ Add database</h1>
        ...
        <script>
            function expand(i) {
                var x = i.id;
                console.log(x);
                var y = document.getElementById(x).nextElementSibling;
                console.log(y);
                if (y.getAttribute('class') == "close") {
                    y.setAttribute('class' , 'open');
                }
